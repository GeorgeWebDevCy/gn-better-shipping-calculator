...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
        ...
        <section class="shipping-calculator-form" id="shipping-calculator-form" style="display:none;">
                ...
                <p class="form-row form-row-wide" id="calc_shipping_address_1_field">
                        <label for="calc_shipping_address_1"><?php esc_html_e( 'Address line 1', 'woocommerce' ); ?> <span class="required">*</span></label>
                        <input type="text" class="input-text" value="<?php echo esc_attr( WC()->customer->get_shipping_address_1() ); ?>" name="calc_shipping_address_1" id="calc_shipping_address_1" required />
                </p>

                <p class="form-row form-row-wide" id="calc_shipping_address_2_field">
                        <label for="calc_shipping_address_2"><?php esc_html_e( 'Address line 2', 'woocommerce' ); ?></label>
                        <input type="text" class="input-text" value="<?php echo esc_attr( WC()->customer->get_shipping_address_2() ); ?>" name="calc_shipping_address_2" id="calc_shipping_address_2" />
                </p>
